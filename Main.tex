...
\textsc{\Large evaluation of the advantages and disadvantages of yocto compared to buildroot }\\[0.3cm] % heading course name
...
\input{Chapters/DiscussionsConclusion}
